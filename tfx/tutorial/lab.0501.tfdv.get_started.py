...
if args.step or args.all:
    if not os.path.exists('tmp/tfx_t0501/'):
        os.mkdir('tmp/tfx_t0501/') 
...
if args.step >= 1:
    ...
    data_url = 'https://storage.googleapis.com/artifacts.tfx-oss-public.appspot.com/datasets/chicago_data.zip'
    dataset_path = tf.keras.utils.get_file(
        fname='chicago_data.zip',
        origin=data_url,
        extract=True,
        cache_subdir='datasets/chicago_data'
    ) 
...
args.step = auto_increment(args.step, args.all)
### Step #2 - Compute and visualize statistics
if args.step >= 2:
    print("\n### Step #2 - Compute and visualize statistics")
